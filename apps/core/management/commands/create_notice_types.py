...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        notification.create_notice_type("cancelled_by_mentor", _("Meeting cancelled by mentor"), _("your meeting has been cancelled"))
        notification.create_notice_type("cancelled_by_protege", _("Meeting cancelled by protege"), _("your meeting has been cancelled"))
