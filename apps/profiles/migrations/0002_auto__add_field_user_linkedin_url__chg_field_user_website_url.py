...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.linkedin_url'
        db.add_column(u'profiles_user', 'linkedin_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


        # Changing field 'User.website_url'
        db.alter_column(u'profiles_user', 'website_url', self.gf('django.db.models.fields.URLField')(max_length=200))

    def backwards(self, orm):
        # Deleting field 'User.linkedin_url'
        db.delete_column(u'profiles_user', 'linkedin_url')


        # Changing field 'User.website_url'
        db.alter_column(u'profiles_user', 'website_url', self.gf('django.db.models.fields.URLField')(max_length=50))
