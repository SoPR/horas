...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'User.day_of_week'
        db.delete_column(u'profiles_user', 'day_of_week')


    def backwards(self, orm):
        # Adding field 'User.day_of_week'
        db.add_column(u'profiles_user', 'day_of_week',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, max_length=1, null=True, db_index=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'profiles.user': {
            ...
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cities_light.City']", 'null': 'True', 'blank': 'True'}),
