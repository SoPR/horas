...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.search_index'
        db.add_column(u'profiles_user', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.search_index'
        db.delete_column(u'profiles_user', 'search_index')
    ...
    models = {
        ...
        u'profiles.user': {
            ...
            'timezone': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '255'}),
