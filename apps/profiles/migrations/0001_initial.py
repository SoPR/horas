...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'profiles_user', (
            ...
            ('is_gravatar_verified', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('day_of_week', self.gf('django.db.models.fields.IntegerField')(db_index=True, max_length=1, null=True, blank=True)),
            ('start_time', self.gf('django.db.models.fields.TimeField')(null=True, blank=True)),
            ('timezone', self.gf('django.db.models.fields.CharField')(default='America/Puerto_Rico', max_length=255)),
