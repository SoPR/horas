    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "day_of_week",
                    apps.profiles.fields.DaysOfWeekField(
                        blank=True,
                        choices=[
                            (0, "Lunes"),
                            (1, "Martes"),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("Africa/Casablanca", "Africa/Casablanca (GMT +0000)"),
                            ("Africa/Ceuta", "Africa/Ceuta (GMT +0100)"),
                            ...
                            ("Africa/El_Aaiun", "Africa/El_Aaiun (GMT +0000)"),
                            ...
                            ("America/Cancun", "America/Cancun (GMT -0600)"),
                            ...
                            ("America/Chihuahua", "America/Chihuahua (GMT -0700)"),
                            ...
                            ("America/Godtha", "America/Godthab (GMT -0300)"),
                            ...
                            (
                                ...
                                "America/Lower_Princes (GMT -0400)",
                            ),
                            ...
                            ("America/Mazatlan", "America/Mazatlan (GMT -0700)"),
                            ("America/Menominee", "America/Menominee (GMT -0500)"),
                            ("America/Merida", "America/Merida (GMT -0600)"),
                            ("America/Metlakatla", "America/Metlakatla (GMT -0800)"),
                            ("America/Mexico_City", "America/Mexico_City (GMT -0600)"),
                            ("America/Miquelon", "America/Miquelon (GMT -0200)"),
                            ("America/Moncton", "America/Moncton (GMT -0300)"),
                            ("America/Monterrey", "America/Monterrey (GMT -0600)"),
                            ...
                            (
                                ...
                                "America/Port-au-Prince (GMT -0400)",
                            ),
                            (
                            ...
                            (
                                ...
                                "America/Santa_Isabel (GMT -0800)",
                            ),
                            ("America/Santarem", "America/Santarem (GMT -0300)"),
                            ("America/Santiago", "America/Santiago (GMT -0300)"),
                            (
                            ...
                            (
                                ...
                                "Antarctica/Macquarie (GMT +1100)",
                            ),
                            ("Antarctica/Mawson", "Antarctica/Mawson (GMT +0500)"),
                            ("Antarctica/McMurdo", "Antarctica/McMurdo (GMT +1300)"),
                            ...
                            ("Antarctica/Troll", "Antarctica/Troll (GMT +0000)"),
                            ("Antarctica/Vostok", "Antarctica/Vostok (GMT +0600)"),
                            ("Arctic/Longyearbyen", "Arctic/Longyearbyen (GMT +0100)"),
                            ("Asia/Aden", "Asia/Aden (GMT +0300)"),
                            ("Asia/Almaty", "Asia/Almaty (GMT +0600)"),
                            ("Asia/Amman", "Asia/Amman (GMT +0200)"),
                            ...
                            ("Asia/Beirut", "Asia/Beirut (GMT +0200)"),
                            ...
                            ("Asia/Damascus", "Asia/Damascus (GMT +0200)"),
                            ...
                            ("Asia/Gaza", "Asia/Gaza (GMT +0200)"),
                            ("Asia/Harbin", "Asia/Harbin (GMT +0800)"),
                            ("Asia/Hebron", "Asia/Hebron (GMT +0200)"),
                            ...
                            ("Asia/Jerusalem", "Asia/Jerusalem (GMT +0200)"),
                            ...
                            ("Asia/Nicosia", "Asia/Nicosia (GMT +0200)"),
                            ...
                            ("Asia/Tehran", "Asia/Tehran (GMT +0330)"),
                            ...
                            ("Atlantic/Azores", "Atlantic/Azores (GMT -0100)"),
                            ("Atlantic/Bermuda", "Atlantic/Bermuda (GMT -0300)"),
                            ("Atlantic/Canary", "Atlantic/Canary (GMT +0000)"),
                            ("Atlantic/Cape_Verde", "Atlantic/Cape_Verde (GMT -0100)"),
                            ("Atlantic/Faroe", "Atlantic/Faroe (GMT +0000)"),
                            ("Atlantic/Madeira", "Atlantic/Madeira (GMT +0000)"),
                            ...
                            ("Australia/Adelaide", "Australia/Adelaide (GMT +1030)"),
                            ("Australia/Brisbane", "Australia/Brisbane (GMT +1000)"),
                            (
                                "Australia/Broken_Hill",
                                "Australia/Broken_Hill (GMT +1030)",
                            ),
                            ("Australia/Currie", "Australia/Currie (GMT +1100)"),
                            ("Australia/Darwin", "Australia/Darwin (GMT +0930)"),
                            ("Australia/Eucla", "Australia/Eucla (GMT +0845)"),
                            ("Australia/Hobart", "Australia/Hobart (GMT +1100)"),
                            ("Australia/Lindeman", "Australia/Lindeman (GMT +1000)"),
                            ("Australia/Lord_Howe", "Australia/Lord_Howe (GMT +1100)"),
                            ("Australia/Melbourne", "Australia/Melbourne (GMT +1100)"),
                            ("Australia/Perth", "Australia/Perth (GMT +0800)"),
                            ("Australia/Sydney", "Australia/Sydney (GMT +1100)"),
                            ...
                            ("Europe/Amsterdam", "Europe/Amsterdam (GMT +0100)"),
                            ("Europe/Andorra", "Europe/Andorra (GMT +0100)"),
                            ("Europe/Athens", "Europe/Athens (GMT +0200)"),
                            ("Europe/Belgrade", "Europe/Belgrade (GMT +0100)"),
                            ("Europe/Berlin", "Europe/Berlin (GMT +0100)"),
                            ("Europe/Bratislava", "Europe/Bratislava (GMT +0100)"),
                            ("Europe/Brussels", "Europe/Brussels (GMT +0100)"),
                            ("Europe/Bucharest", "Europe/Bucharest (GMT +0200)"),
                            ("Europe/Budapest", "Europe/Budapest (GMT +0100)"),
                            ("Europe/Busingen", "Europe/Busingen (GMT +0100)"),
                            ("Europe/Chisinau", "Europe/Chisinau (GMT +0200)"),
                            ("Europe/Copenhagen", "Europe/Copenhagen (GMT +0100)"),
                            ("Europe/Dublin", "Europe/Dublin (GMT +0000)"),
                            ("Europe/Gibraltar", "Europe/Gibraltar (GMT +0100)"),
                            ("Europe/Guernsey", "Europe/Guernsey (GMT +0000)"),
                            ("Europe/Helsinki", "Europe/Helsinki (GMT +0200)"),
                            ("Europe/Isle_of_Man", "Europe/Isle_of_Man (GMT +0000)"),
                            ("Europe/Istanbul", "Europe/Istanbul (GMT +0200)"),
                            ("Europe/Jersey", "Europe/Jersey (GMT +0000)"),
                            ("Europe/Kaliningrad", "Europe/Kaliningrad (GMT +0300)"),
                            ("Europe/Kiev", "Europe/Kiev (GMT +0200)"),
                            ("Europe/Lisbon", "Europe/Lisbon (GMT +0000)"),
                            ("Europe/Ljubljana", "Europe/Ljubljana (GMT +0100)"),
                            ("Europe/London", "Europe/London (GMT +0000)"),
                            ("Europe/Luxembourg", "Europe/Luxembourg (GMT +0100)"),
                            ("Europe/Madrid", "Europe/Madrid (GMT +0100)"),
                            ("Europe/Malta", "Europe/Malta (GMT +0100)"),
                            ("Europe/Mariehamn", "Europe/Mariehamn (GMT +0200)"),
                            ("Europe/Minsk", "Europe/Minsk (GMT +0300)"),
                            ("Europe/Monaco", "Europe/Monaco (GMT +0100)"),
                            ("Europe/Moscow", "Europe/Moscow (GMT +0400)"),
                            ("Europe/Oslo", "Europe/Oslo (GMT +0100)"),
                            ("Europe/Paris", "Europe/Paris (GMT +0100)"),
                            ("Europe/Podgorica", "Europe/Podgorica (GMT +0100)"),
                            ("Europe/Prague", "Europe/Prague (GMT +0100)"),
                            ("Europe/Riga", "Europe/Riga (GMT +0200)"),
                            ("Europe/Rome", "Europe/Rome (GMT +0100)"),
                            ("Europe/Samara", "Europe/Samara (GMT +0400)"),
                            ("Europe/San_Marino", "Europe/San_Marino (GMT +0100)"),
                            ("Europe/Sarajevo", "Europe/Sarajevo (GMT +0100)"),
                            ("Europe/Simferopol", "Europe/Simferopol (GMT +0400)"),
                            ("Europe/Skopje", "Europe/Skopje (GMT +0100)"),
                            ("Europe/Sofia", "Europe/Sofia (GMT +0200)"),
                            ("Europe/Stockholm", "Europe/Stockholm (GMT +0100)"),
                            ("Europe/Tallinn", "Europe/Tallinn (GMT +0200)"),
                            ("Europe/Tirane", "Europe/Tirane (GMT +0100)"),
                            ("Europe/Uzhgorod", "Europe/Uzhgorod (GMT +0200)"),
                            ("Europe/Vaduz", "Europe/Vaduz (GMT +0100)"),
                            ("Europe/Vatican", "Europe/Vatican (GMT +0100)"),
                            ("Europe/Vienna", "Europe/Vienna (GMT +0100)"),
                            ("Europe/Vilnius", "Europe/Vilnius (GMT +0200)"),
                            ("Europe/Volgograd", "Europe/Volgograd (GMT +0400)"),
                            ("Europe/Warsaw", "Europe/Warsaw (GMT +0100)"),
                            ("Europe/Zagre", "Europe/Zagreb (GMT +0100)"),
                            ("Europe/Zaporozhye", "Europe/Zaporozhye (GMT +0200)"),
                            ("Europe/Zurich", "Europe/Zurich (GMT +0100)"),
                            ("GMT", "GMT (GMT +0000)"),
                            ...
                            ("Pacific/Apia", "Pacific/Apia (GMT +1400)"),
                            ("Pacific/Auckland", "Pacific/Auckland (GMT +1300)"),
                            ("Pacific/Chatham", "Pacific/Chatham (GMT +1345)"),
                            ("Pacific/Chuuk", "Pacific/Chuuk (GMT +1000)"),
                            ("Pacific/Easter", "Pacific/Easter (GMT -0500)"),
