...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.featured'
        db.add_column('profiles_user', 'featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.featured'
        db.delete_column('profiles_user', 'featured')
    ...
    models = {
        ...
        'profiles.user': {
            ...
            'day_of_week': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'max_length': '1', 'blank': 'True', 'null': 'True'}),
