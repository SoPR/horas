...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Meeting.state'
        db.alter_column(u'meetings_meeting', 'state', self.gf('django_states.fields.StateField')(max_length=100))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Meeting.state'
        db.alter_column(u'meetings_meeting', 'state', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        u'meetings.meeting': {
            ...
            'state': ('django_states.fields.StateField', [], {'default': "'available'", 'max_length': '100'})
        },
