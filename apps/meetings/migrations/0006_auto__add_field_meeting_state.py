...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meeting.state'
        db.add_column(u'meetings_meeting', 'state',
                      self.gf('django.db.models.fields.CharField')(default='available', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Meeting.state'
        db.delete_column(u'meetings_meeting', 'state')
    ...
    models = {
        ...
        u'meetings.meeting': {
            ...
            'state': ('django.db.models.fields.CharField', [], {'default': "'available'", 'max_length': '50'})
        },
        u'profiles.user': {
