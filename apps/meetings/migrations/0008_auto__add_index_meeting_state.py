...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Meeting', fields ['state']
        db.create_index(u'meetings_meeting', ['state'])


    def backwards(self, orm):
        # Removing index on 'Meeting', fields ['state']
        db.delete_index(u'meetings_meeting', ['state'])
